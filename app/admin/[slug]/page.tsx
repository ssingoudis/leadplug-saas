...
export default async function FunnelDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-[#0d1117]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8 grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">

        {/* LEFT: iframe preview */}
        <div className="lg:col-span-3">
          <SuccessPreviewBlock src={funnelUrl} title="Funnel-Vorschau" defaultOpen />
          <div className="mt-4">
            <SuccessPreviewBlock src={`/admin/${slug}/contact-preview`} title="Kontaktformular" />
          </div>
          <div className="mt-4">
            <SuccessPreviewBlock src={`/admin/${slug}/success-preview`} />
          </div>
          <div className="mt-4">
            <EmailPreviewBlock title="Bestätigungs-E-Mail (Anfragender)" src={`/admin/${slug}/email-preview`} />
          </div>
          <div className="mt-4">
            <EmailPreviewBlock title="Lead-Benachrichtigung (Tenant)" src={`/admin/${slug}/lead-preview`} />
          </div>
          <div className="mt-4">
