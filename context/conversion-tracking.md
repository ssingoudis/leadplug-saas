...
| [`components/tenant-editor/v2/SharePanel.tsx`](../components/tenant-editor/v2/SharePanel.tsx) | **Editor-Reiter „Einbinden" pro Funnel** (Aufgabe 43): Snippet (Script primär + iFrame-Fallback) · Conversion-Tracking-Felder (`TrackingSettings`) · Plattform-Anleitungen (`PlatformGuides`) · GTM/Callback-Details. Lädt Tracking via GET, speichert via PATCH. |
