...
const Icons = {
  ...
  Calendar: ({ color = "#444", text = "" }: { color?: string; text?: string }) => (
    <svg viewBox="0 0 64 64" className="w-full h-full" fill={color}>
      ...
      <text x="32" y="44" textAnchor="middle" fontSize="16" fontWeight="bold" fontFamily="Arial">{text}</text>
    </svg>
  ),
}
...
const questionsConfig: QuestionConfig[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Weiß nicht / bitte Beratung", value: "unsicher", iconKey: "Question" },
    ],
  },
  {
    id: "zeitraum",
    ...
    defaultValue: "1-3",
    options: [
      { label: "umgehend", value: "umgehend", iconKey: "Calendar", iconProps: { text: "<1" } },
      { label: "In 1 bis 3 Monaten", value: "1-3", iconKey: "Calendar", iconProps: { text: "1-3" } },
      { label: "In 3 bis 6 Monaten", value: "3-6", iconKey: "Calendar", iconProps: { text: "3-6" } },
      { label: "Weiß nicht", value: "unsicher", iconKey: "Question" },
    ],
  },
]
...
interface SolarFunnelProps {
  ...
  onSubmit?: (data: { answers: Record<string, string>; contact: ContactData }) => void
}
        ...
        {!isContactStep ? (
              ...
              {currentQuestion.options.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Radio Circle */}
                    <div 
                      className="w-4 h-4 rounded-full border-2 mb-1.5 flex items-center justify-center transition-colors"
                      style={{ borderColor: isSelected ? theme.primaryColor : theme.borderColor }}
                    >
                      {isSelected && (
                        <div 
          ...
          <div>
            ...
            <p 
              ...
              style={{ color: theme.textColorMuted }}
            >
              Mit Klick auf &quot;Angebotsvergleich starten&quot; stimme ich zu, zwecks Photovoltaik Angebotsvergleich per E-Mail &amp; Telefon kontaktiert zu werden. Widerrufen geht jederzeit. Mehr Infos in den{" "}
              <a href="#" style={{ color: theme.primaryColor }} className="underline">Datenschutzhinweisen</a>.
            </p>
