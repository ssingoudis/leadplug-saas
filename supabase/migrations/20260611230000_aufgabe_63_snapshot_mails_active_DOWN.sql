-- =============================================================================
-- Aufgabe 63 — Snapshot-Härtung (DOWN)
--
-- Stellt die Aufgabe-62-Fassung von snapshot_funnel_to_template wieder her
-- (emails-Sektion kopiert wieder `e.is_active` statt konstant true).
-- Reihenfolge beachten: Es gibt keinen Code-Pfad, der von der UP-Fassung
-- abhängt — der Rollback ist jederzeit gefahrlos möglich. Bereits publizierte
-- Template-Definitionen bleiben unverändert (Snapshot-Daten, keine Live-Refs).
-- =============================================================================
