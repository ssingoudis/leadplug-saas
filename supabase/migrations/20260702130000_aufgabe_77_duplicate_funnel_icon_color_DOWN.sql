-- Aufgabe 77 — duplicate_funnel kopiert icon_color mit (DOWN)
-- Stellt die Aufgabe-62-Fassung wieder her (ohne icon_color in Spalten/VALUES).
-- Vor dem Droppen der Spalte (20260702120000_DOWN) ausführen, sonst referenziert
-- die Funktion eine nicht existierende Spalte.
