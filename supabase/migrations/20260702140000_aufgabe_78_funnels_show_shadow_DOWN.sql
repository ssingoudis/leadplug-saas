-- Aufgabe 78 — Einbett-Feinschliff: Schatten abschaltbar (DOWN)
-- Stellt die Aufgabe-77-Fassung von duplicate_funnel wieder her (ohne show_shadow)
-- und droppt danach die Spalte. Reihenfolge wichtig: erst Funktion, dann Spalte —
-- und davor den Code zurückrollen (PUT schreibt die Spalte).
...
ALTER TABLE funnels
  DROP COLUMN IF EXISTS show_shadow;
